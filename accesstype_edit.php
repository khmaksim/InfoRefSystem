        ...
        ?>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Редактирование форм допуска
                        <small><?= ($_GET['act'] == 'add') ? 'Добавление.' : 'Редактирование.'; ?></small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="/"><i class="fa fa-dashboard"></i> Главная</a></li>
                        <li><a href="/accesstype.php">Формы допуска</a></li>
                            ...
                            <div class="box box-primary">
                                ...
                                <form name="editform" role="form" action="/save.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="box-footer">
                                        <a href="/accesstype.php" type="submit" class="btn btn-default">Отмена</a> <a onclick="checkForm();" type="submit" class="btn btn-primary">Сохранить</a>
                                    </div>
                                </form>
                            </div>
                        </div><!-- /.col -->
        ...
        /*<![CDATA[*/
            function checkForm()
            {
                if (document.editform.name.value != '') {
                    ...
                    alert('Укажите наименование формы допуска!');
                }
            }
        /*]]>*/
        </script>
