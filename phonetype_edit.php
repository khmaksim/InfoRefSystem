    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        ?>
            ...
            <div class="content-wrapper">
                ...
                <?php
                    if ($_GET['act'] == 'edit') {
                        $arPhoneType = getPhoneTypeById($_GET['id']);
                    }
                ?>
                                ...
                                <form name="editform" role="form" action="/save.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Наименование типа телефонной связи"<?= ($_GET['act'] == 'edit') ? ' value="' . $arPhoneType['name'] . '"' : ''; ?> required autofocus>
                                        </div>
                                    </div><!-- /.box-body -->

                                    <div class="box-footer">
                                        <a href="/phonetype.php" type="submit" class="btn btn-default">Отмена</a> <a onclick="checkForm();" type="submit" class="btn btn-primary">Сохранить</a>
                                    </div>
                                </form>
                            </div>
                        </div><!-- /.col -->
        ...
        /*<![CDATA[*/
            function checkForm()
            {
                if (document.editform.name.value != '') {
                    ...
                    alert('Укажите наименование типа телефонной связи!');
                }
            }
        /*]]>*/
        </script>
