    ...
    if (!is_null($request)) {
        ...
        foreach ($department_tree as $department) {
            ...
            echo '<li class="tree"><a href="/unit.php?id=' . $department->id . '"><i class="fa fa-angle-right text-yellow"></i> <span>' . $department->fullname . '</span> </a>
                ...
                <li><a href="/?cmd=Unit&id_department=' . $department->id . '">Штатное расписание</a></li>
                <li><a href="/?cmd=Person&id_department=' . $department->id . '">Личный состав</a></li>
                <li><a href="/?cmd=Technique&id_department=' . $department->id . '">Техника</a></li>';
