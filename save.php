<?php
    ...
    else if(preg_match("/accesstype/i", $act)) echo "\n<META http-equiv='REFRESH' content='0; url=./accesstype.php'>";
    else if(preg_match("/interpassporttype/i", $act)) echo "\n<META http-equiv='REFRESH' content='0; url=./interpassporttype.php'>";
    else if(preg_match("/medaltype/i", $act)) echo "\n<META http-equiv='REFRESH' content='0; url=./medaltype.php'>";
    else if(preg_match("/phonetype/i", $act)) echo "\n<META http-equiv='REFRESH' content='0; url=./phonetype.php'>";
    else if(preg_match("/phonenumbertype/i", $act)) echo "\n<META http-equiv='REFRESH' content='0; url=./phonenumbertype.php'>";
    else if(preg_match("/militaryposition/i", $act)) echo "\n<META http-equiv='REFRESH' content='0; url=./militaryposition.php'>";
    else if(preg_match("/militaryrank/i", $act)) echo "\n<META http-equiv='REFRESH' content='0; url=./militaryrank.php'>";
    else if(preg_match("/role/i", $act)) echo "\n<META http-equiv='REFRESH' content='0; url=./role.php'>";
    ...
    else if(preg_match("/addresstype/i", $act)) echo "\n<META http-equiv='REFRESH' content='0; url=./addresstype.php'>";
    else if(preg_match("/emailtype/i", $act)) echo "\n<META http-equiv='REFRESH' content='0; url=./emailtype.php'>";
