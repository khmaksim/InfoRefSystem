<?php
    ...
    ConnectDatabase();
                            ...
                            // Выполним SQL запрос
                            try {
                                $sql = 'SELECT * FROM tmilitaryrank ORDER BY id';
                        ...
                        <tr>
                            ...
                            ?>
                            <td class="col-xs-1 text-center"><a href="/dictionary_edit.php?name=militaryrank&act=edit&id=<?= $row['id']; ?>" class="button btn-success btn-sm"><span class="glyphicon glyphicon-pencil"></span></a></td>
