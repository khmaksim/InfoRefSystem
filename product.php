...
<script src="/dist/js/app.min.js"></script>
        <!-- Optionally, you can add Slimscroll and FastClick plugins.
            ...
            //     $($(this).find('p')[0]).text(num);
            //     num = num + 1;
            //     $(this).show()
            // }
            // else {
            //     var serialNumber = $(this).find('p')[5];
            //     var sideNumber = $(this).find('p')[3];
            //     if ($(serialNumber).text().indexOf(searchValue) >= 0 || $(sideNumber).text().indexOf(searchValue) >= 0) {
            //         $($(this).find('p')[0]).text(num);
            //         num = num + 1;
            //         $(this).show();
            //     }
