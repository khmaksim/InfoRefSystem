    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="col-xs-12">
                                    ...
                                    <tbody id="items">
                                    <?php
                                            $scientific_work_list = $request->getProperty('scientific_work_list');
                                            $count = 1;
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <p class="text-right"><a href="./?cmd=AddScientificWork" type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Добавить</a></p>
                    </div><!-- /.col -->
                </div>
        </section><!-- /.content -->
    </div><!-- /.content-wrapper -->
             ...
             <script language="JavaScript" type="text/javascript">
                ...
                function ConfirmDelete(id)
                {
                    ...
                    if(confirm("Вы действительно хотите удалить запись?")) {
                        document.location = "./?cmd=DeleteScientificWork&id=" + ObjectId;
                    }
                }                
                /*]]>*/
            </script>
