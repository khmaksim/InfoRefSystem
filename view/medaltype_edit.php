<?php
    ...
    $edit_medal_type = $request->getProperty('medal_type');
    $action = $request->getProperty('cmd');
    $action_name = ($action == 'AddMedalType') ? 'Добавление' : 'Редактирование';
?>
                                ...
                                <form name="editform" role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="inputName" placeholder="Наименование типа награды"<?= ($action == 'EditMedalType') ? ' value="' . $edit_medal_type->name . '"' : ''; ?> required autofocus>
                                        </div>
                                    </div><!-- /.box-body -->
                                    <div class="box-footer">
                                        <a href="/?cmd=MedalType" type="submit" class="btn btn-default">Отмена</a> <a onclick="checkForm();" type="submit" class="btn btn-primary">Сохранить</a>
                                    </div>
                                </form>
                            </div>
                        </div><!-- /.col -->
