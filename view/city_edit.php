<?php
    ...
    $edit_city = $request->getProperty('city');
    $action = $request->getProperty('cmd');
    $action_name = ($action == 'AddCity') ? 'Добавление' : 'Редактирование';
?>
                                ...
                                <form name="editform" role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Наименование города"<?= ($action == 'EditCity') ? ' value="' . $edit_military_rank->name . '"' : ''; ?> required autofocus>
                                        </div>
                                    </div><!-- /.box-body -->
                                    <div class="box-footer">
                                        <a href="/?cmd=City" type="submit" class="btn btn-default">Отмена</a> <a onclick="checkForm();" type="submit" class="btn btn-primary">Сохранить</a>
                                    </div>
                                </form>
                            </div>
                        </div><!-- /.col -->
