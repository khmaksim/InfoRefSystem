<?php
    function showDepartmentsNavTree($id=0, $hideSubDepartment=false) {
        global $dbconn;
        ...
        foreach ($dbconn->query($sql) as $row) {
            if (haveChilde($row['id'])) {
                echo '
                    ...
                    if (!$hideSubDepartment) {
                        echo '<li><a href="/unit.php?id=' . $row['id'] . '"><i class="fa fa-circle-o text-red"></i> <span>Штатное расписание</span></a></li>
                ...
                showDepartmentsNavTree($row['id'], $hideSubDepartment);
                echo '
                      </ul>
                    </li>
