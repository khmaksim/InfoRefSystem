    ...
    <body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
        ...
        ?>
            ...
            <div class="content-wrapper">
                ...
                <!-- Your Page Content Here -->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <p class="text-right"><a href="/city_edit.php?act=add" type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Добавить</a></p>
                        </div><!-- /.col -->
                    </div>
                </section><!-- /.content -->
            </div><!-- /.content-wrapper -->
        ...
        /*<![CDATA[*/
            $(document).ready(function(){
      		    $("#items").load("/city.func.php");
                setInterval(function() {$("#items").load("/city.func.php");}, 5000);
            });
            ...
            function ConfirmDelete(id)
            {
                ...
                if(confirm("Вы действительно хотите удалить запись?")) {
                    document.location = "./save.php?id="+ObjectId+"&act=delCity";
                }
            }
        /*]]>*/
        </script>
