            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="/phonenumbertype.php">Типы номеров телефонной связи</a></li>
                            ...
                            <div class="box box-primary">
                                ...
                                <form name="editform" role="form" action="/save.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="box-footer">
                                        <a href="/phonenumbertype.php" type="submit" class="btn btn-default">Отмена</a> <a onclick="checkForm();" type="submit" class="btn btn-primary">Сохранить</a>
                                    </div>
                                </form>
                            </div>
                        </div><!-- /.col -->
        ...
        /*<![CDATA[*/
            function checkForm()
            {
                if (document.editform.name.value != '') {
                    ...
                    alert('Укажите наименование типа номера телефонной связи!');
                }
            }
        /*]]>*/
        </script>
