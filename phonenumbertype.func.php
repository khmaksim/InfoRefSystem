<?php
    ...
    ConnectDatabase();
                        ...
                        <tr>
                            ...
                            ?>
                            <td class="col-xs-1 text-center"><a href="/phonenumbertype_edit.php?act=edit&id=<?= $row['id']; ?>" class="button btn-success btn-sm"><span class="glyphicon glyphicon-pencil"></span></a></td>
