                            ...
                            <div class="box box-primary">
                                ...
                                <form name="role" role="form" action="/save.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="box-footer">
                                        <a href="/militaryrank.php" type="submit" class="btn btn-default">Отмена</a> <a onclick="checkForm();" type="submit" class="btn btn-primary">Сохранить</a>
                                    </div>
                                </form>
                            </div>
                        </div><!-- /.col -->
        ...
        /*<![CDATA[*/
            function checkForm()
            {
                if (document.role.title.value != '') {
                    ...
                    alert('Укажите название воинского звания!');
                }
            }
        /*]]>*/
        </script>
